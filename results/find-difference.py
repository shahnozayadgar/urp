...
def normalize_caps(sql):
    ...
    # Remove everything from the first semicolon to the end of the line
    sql = re.sub(r';.*$', '', sql)
...
golden_truth_file = 'single-tables-dev-gold-half.sql'
prediction_file = 'normalized-single-tables-preds-half-training.sql'
differences_file = 'differences_train-current.sql'
